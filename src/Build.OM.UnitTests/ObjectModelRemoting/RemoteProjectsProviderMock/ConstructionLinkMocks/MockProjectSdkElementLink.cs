...
namespace Microsoft.Build.UnitTests.OM.ObjectModelRemoting
{
    ...
    internal class MockProjectSdkElementLinkRemoter : MockProjectElementContainerLinkRemoter
    {
        ...
        {
            var link = new MockProjectSdkElementLink(this, remote);
    ...
    {
        public MockProjectSdkElementLink(MockProjectSdkElementLinkRemoter proxy, ProjectCollectionLinker linker)
        {
            this.Linker = linker;
            this.Proxy = proxy;
        }
