...
namespace Microsoft.Build.UnitTests.OM.ObjectModelRemoting
{
    ...
    internal class MockProjectUsingTaskElementLinkRemoter : MockProjectElementContainerLinkRemoter
    {
        ...
        {
            var link = new MockProjectUsingTaskElementLink(this, remote);
    ...
    {
        public MockProjectUsingTaskElementLink(MockProjectUsingTaskElementLinkRemoter proxy, ProjectCollectionLinker linker)
        {
            this.Linker = linker;
            this.Proxy = proxy;
        }
