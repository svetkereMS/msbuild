...
namespace Microsoft.Build.UnitTests.OM.ObjectModelRemoting
{
    ...
    internal class MockProjectWhenElementLinkRemoter : MockProjectElementContainerLinkRemoter
    {
        ...
        {
            var link = new MockProjectWhenElementLink(this, remote);
    ...
    {
        public MockProjectWhenElementLink(MockProjectWhenElementLinkRemoter proxy, ProjectCollectionLinker linker)
        {
            this.Linker = linker;
            this.Proxy = proxy;
        }
