...
namespace Microsoft.Build.UnitTests.OM.ObjectModelRemoting
{
    ...
    internal class MockProjectImportGroupElementLinkRemoter : MockProjectElementContainerLinkRemoter
    {
        ...
        {
            var link = new MockProjectImportGroupElementLink(this, remote);
    ...
    {
        public MockProjectImportGroupElementLink(MockProjectImportGroupElementLinkRemoter proxy, ProjectCollectionLinker linker)
        {
            this.Linker = linker;
            this.Proxy = proxy;
        }
