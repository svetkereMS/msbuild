...
{
    public abstract class ProjectTargetElementtLink : ProjectElementContainerLink
    {
    ...
    {
        internal ProjectTargetElementtLink TargetLink => (ProjectTargetElementtLink)Link;

        /// <summary>
        /// External projects support
        /// </summary>
        internal ProjectTargetElement(ProjectTargetElementtLink link)
            : base(link)
        {
        }
